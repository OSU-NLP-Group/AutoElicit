...
COMPUTER_USE_BETA_FLAG_OPUS_4_6 = "computer-use-2025-11-24"
...
PROVIDER_TO_DEFAULT_MODEL_NAME: dict[(APIProvider, str), str] = {
    ...
    (APIProvider.VERTEX, "claude-haiku-4-5-20251001"): "claude-haiku-4-5-v1@20251001",
    ...
    (APIProvider.VERTEX, "claude-sonnet-4-5-202509299"): "claude-sonnet-4-5-v1@20250929",
    (APIProvider.ANTHROPIC, "claude-opus-4-5-20251101"): "claude-opus-4-5-20251101",
    (APIProvider.BEDROCK, "claude-opus-4-5-20251101"): "us.anthropic.claude-opus-4-5-20251101-v1:0",
    (APIProvider.VERTEX, "claude-opus-4-5-20251101"): "claude-opus-4-5-v1@20251101",
    (APIProvider.ANTHROPIC, "claude-opus-4-6"): "claude-opus-4-6",
    (APIProvider.BEDROCK, "claude-opus-4-6"): "us.anthropic.claude-opus-4-6-v1",
    (APIProvider.VERTEX, "claude-opus-4-6"): "claude-opus-4-6-v1",
}
...
def get_model_name(provider: APIProvider, model_name: str) -> str:
    ...
    """
    return PROVIDER_TO_DEFAULT_MODEL_NAME[(provider, model_name)]
