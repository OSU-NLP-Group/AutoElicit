...
from .utils import COMPUTER_USE_BETA_FLAG, COMPUTER_USE_BETA_FLAG_OPUS_4_6, PROMPT_CACHING_BETA_FLAG,SYSTEM_PROMPT, SYSTEM_PROMPT_WINDOWS, APIProvider, PROVIDER_TO_DEFAULT_MODEL_NAME, get_model_name
...
class AnthropicAgent:
    ...
    def predict(self, task_instruction: str, obs: Dict = None, system: Any = None):
        ...
        betas = [COMPUTER_USE_BETA_FLAG if self.model_name != "claude-opus-4-6" else COMPUTER_USE_BETA_FLAG_OPUS_4_6]
        ...
        if self.provider == APIProvider.ANTHROPIC:
            client = Anthropic(api_key=self.api_key, max_retries=4).with_options(
                default_headers={"anthropic-beta": COMPUTER_USE_BETA_FLAG if self.model_name != "claude-opus-4-6" else COMPUTER_USE_BETA_FLAG_OPUS_4_6}
            )
